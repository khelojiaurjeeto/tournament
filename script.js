function getUsernameFromLocalStorage() {
  return localStorage.getItem('khelo_local');
}
...
function fetchUserCoins(username) {
  ...
  const url = 'https://script.google.com/macros/s/AKfycbwyaX5IwlceVTiFADwOrWwHW2nmNvyj_341dOCeQMsyzPaJrGMONKiZayGrUrwNhAw/exec';
